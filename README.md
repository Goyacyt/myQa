...
dataset_modify.py是主函数，其中引用4个模型，分别take原训练集的{context,question}和手动修改过的{context,question}后，分别得到ori_answer和rev_answer，两个answer不完全相同时，输出：
...
squad2_valid_qc_x_result.txt是全部的输出，没有经过answer对比的筛选
